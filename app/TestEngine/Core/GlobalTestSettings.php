...
abstract class GlobalTestSettings
{
    ...
    /**
     * Количество промежуточных баллов, которые будут начислены за ответ на сложный вопрос при подсчёте
     * итоговой оценки студента за тест.
     * Для простого вопроса значение равно 1, для среднего - среднее между 1 и complexQuestionPoints.
     */
    const complexQuestionPointsKey = 'complexQuestionPoints';
    const complexQuestionPoints = 1.5;
