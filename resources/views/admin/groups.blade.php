...
@section('content')
    <div class="content">
        ...
        <div class="institutes">
            <!-- ko foreach: groups -->
            <div class="institute" data-bind="click: $root.showGroup, css: {'institute-current': $root.currentGroup().id() === id()}">
        ...
        <div class="info-group">
            ...
            <div class="edit-group">
                ...
                <div class="group-name">
                    <label>Название группы </label><a class="active-link"> (Сгенерировать)</a></br>
                ...
                <div>
                    ...
                    <span data-bind="click: $root.changeForm, css: {'study-form-selected': $root.groupStudyForm() === 'Очная'}" class="study-form">Очная</span>
                    <span> | </span>
                    <span data-bind="click: $root.changeForm, css: {'study-form-selected': $root.groupStudyForm() === 'Заочная'}" class="study-form">Заочная</span>
                </div>
                <div>
                    <button data-bind="click: $root.approve" class="fa">&#xf00c;</button>
                    <button data-bind="click: $root.cancel" class="fa">&#xf00d;</button>
