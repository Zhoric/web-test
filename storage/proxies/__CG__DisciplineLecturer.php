 ...
 */
class DisciplineLecturer extends \DisciplineLecturer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DisciplineLecturer $proxy) {
    ...
    public function setLecturer(\User $lecturer = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLecturer', [$lecturer]);
