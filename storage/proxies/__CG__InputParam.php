 ...
 */
class InputParam extends \InputParam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InputParam $proxy) {
    ...
    public function setParamsSet(\ParamsSet $paramsSet = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParamsSet', [$paramsSet]);

        return parent::setParamsSet($paramsSet);
    }
