 ...
 */
class GivenAnswer extends \GivenAnswer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GivenAnswer $proxy) {
    ...
    public function setRightPercentage($rightPercentage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRightPercentage', [$rightPercentage]);

        return parent::setRightPercentage($rightPercentage);
    }
    ...
    public function getRightPercentage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRightPercentage', []);

        return parent::getRightPercentage();
    }
    ...
    public function setTestResult(\TestResult $testResult = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTestResult', [$testResult]);

        return parent::setTestResult($testResult);
    }
